...
var EmbeddedDefaultsFileSystem = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/certificate": &vfsgen۰DirInfo{
			name:    "certificate",
			modTime: time.Date(2022, 8, 4, 19, 2, 36, 726303484, time.UTC),
		},
		...
		"/integration": &vfsgen۰DirInfo{
			name:    "integration",
			modTime: time.Date(2022, 8, 4, 19, 2, 36, 727894280, time.UTC),
		},
		...
		"/populate": &vfsgen۰DirInfo{
			name:    "populate",
			modTime: time.Date(2022, 8, 4, 19, 2, 36, 731372802, time.UTC),
		},
		...
		"/sanitize": &vfsgen۰DirInfo{
			name:    "sanitize",
			modTime: time.Date(2022, 8, 4, 19, 2, 36, 733200423, time.UTC),
		},
		...
		"/security": &vfsgen۰DirInfo{
			name:    "security",
			modTime: time.Date(2022, 8, 8, 15, 10, 49, 735115209, time.UTC),
		},
		...
		"/transit": &vfsgen۰DirInfo{
			name:    "transit",
			modTime: time.Date(2022, 8, 4, 19, 2, 36, 744476509, time.UTC),
		},
		...
		"/webservice": &vfsgen۰DirInfo{
			name:    "webservice",
			modTime: time.Date(2022, 8, 8, 15, 10, 49, 764832966, time.UTC),
		},
