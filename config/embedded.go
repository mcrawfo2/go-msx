...
var EmbeddedDefaultsFileSystem = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/consul": &vfsgen۰DirInfo{
			name:    "consul",
			modTime: time.Date(2021, 6, 23, 16, 22, 49, 722171989, time.UTC),
		},
		"/consul/defaults-consul.properties": &vfsgen۰FileInfo{
			name:    "defaults-consul.properties",
			modTime: time.Date(2021, 6, 23, 16, 22, 49, 721948830, time.UTC),
		...
		"/discovery": &vfsgen۰DirInfo{
			name:    "discovery",
			modTime: time.Date(2021, 6, 23, 16, 22, 49, 724029950, time.UTC),
		},
		"/discovery/consulprovider": &vfsgen۰DirInfo{
			name:    "consulprovider",
			modTime: time.Date(2021, 7, 16, 18, 13, 58, 59827870, time.UTC),
		},
		"/discovery/consulprovider/defaults-discovery.properties": &vfsgen۰FileInfo{
			name:    "defaults-discovery.properties",
			modTime: time.Date(2020, 9, 24, 15, 38, 8, 992591008, time.UTC),
		...
		"/fs": &vfsgen۰DirInfo{
			name:    "fs",
			modTime: time.Date(2021, 6, 23, 16, 22, 49, 728211027, time.UTC),
		},
		"/fs/defaults-fs.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-fs.properties",
			modTime:          time.Date(2021, 6, 23, 16, 22, 49, 724922935, time.UTC),
		...
		"/integration": &vfsgen۰DirInfo{
			name:    "integration",
			modTime: time.Date(2021, 9, 1, 18, 12, 27, 27783269, time.UTC),
		},
		"/integration/defaults-integration.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-integration.properties",
			modTime:          time.Date(2021, 9, 1, 18, 12, 27, 27698088, time.UTC),
		...
		"/leader": &vfsgen۰DirInfo{
			name:    "leader",
			modTime: time.Date(2021, 8, 27, 21, 48, 43, 311180898, time.UTC),
		},
		"/leader/defaults-leader.yml": &vfsgen۰CompressedFileInfo{
			name:             "defaults-leader.yml",
			modTime:          time.Date(2020, 9, 24, 15, 38, 9, 16163857, time.UTC),
		...
		"/populate": &vfsgen۰DirInfo{
			name:    "populate",
			modTime: time.Date(2021, 7, 16, 18, 13, 58, 71850992, time.UTC),
		},
		"/populate/defaults-populate.properties": &vfsgen۰FileInfo{
			name:    "defaults-populate.properties",
			modTime: time.Date(2021, 6, 23, 16, 22, 49, 767212533, time.UTC),
		...
		"/security": &vfsgen۰DirInfo{
			name:    "security",
			modTime: time.Date(2021, 8, 27, 21, 48, 43, 315194864, time.UTC),
		},
		"/security/idmdetailsprovider": &vfsgen۰DirInfo{
			name:    "idmdetailsprovider",
			modTime: time.Date(2021, 8, 27, 21, 48, 23, 94079047, time.UTC),
		},
		"/security/idmdetailsprovider/defaults-security-idmdetailsprovider.properties": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2021, 7, 16, 18, 13, 58, 74938129, time.UTC),
		...
		"/sqldb": &vfsgen۰DirInfo{
			name:    "sqldb",
			modTime: time.Date(2021, 7, 16, 18, 13, 58, 86526254, time.UTC),
		},
		"/sqldb/defaults-sqldb.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sqldb.properties",
			modTime:          time.Date(2021, 6, 23, 16, 22, 49, 800284024, time.UTC),
		...
		"/transit": &vfsgen۰DirInfo{
			name:    "transit",
			modTime: time.Date(2021, 7, 16, 18, 13, 58, 96235484, time.UTC),
		},
		"/transit/defaults-transit.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-transit.properties",
			modTime:          time.Date(2020, 9, 24, 15, 38, 9, 64346952, time.UTC),
		...
		"/webservice/defaults-webservice.properties": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2021, 8, 27, 21, 48, 43, 327396989, time.UTC),
