...
var EmbeddedDefaultsFileSystem = func() http.FileSystem {
	fs := vfsgen۰FS{
		...
		"/app": &vfsgen۰DirInfo{
			name:    "app",
			modTime: time.Date(2022, 3, 2, 15, 58, 22, 706043478, time.UTC),
		},
		"/app/defaults-app.properties": &vfsgen۰FileInfo{
			name:    "defaults-app.properties",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 404119303, time.UTC),
		...
		"/certificate": &vfsgen۰DirInfo{
			name:    "certificate",
			modTime: time.Date(2022, 3, 28, 18, 59, 24, 940402498, time.UTC),
		},
		"/certificate/defaults-certificate.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-certificate.properties",
			modTime:          time.Date(2022, 2, 17, 19, 17, 35, 243761163, time.UTC),
		...
		"/consul": &vfsgen۰DirInfo{
			name:    "consul",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 454111499, time.UTC),
		},
		"/consul/defaults-consul.properties": &vfsgen۰FileInfo{
			name:    "defaults-consul.properties",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 453605418, time.UTC),
		...
		"/discovery": &vfsgen۰DirInfo{
			name:    "discovery",
			modTime: time.Date(2022, 3, 28, 18, 59, 24, 941201514, time.UTC),
		},
		"/discovery/consulprovider": &vfsgen۰DirInfo{
			name:    "consulprovider",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 455777070, time.UTC),
		},
		"/discovery/consulprovider/defaults-discovery.properties": &vfsgen۰FileInfo{
			name:    "defaults-discovery.properties",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 454782956, time.UTC),
		...
		"/fs": &vfsgen۰DirInfo{
			name:    "fs",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 463229738, time.UTC),
		},
		"/fs/defaults-fs.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-fs.properties",
			modTime:          time.Date(2022, 2, 2, 16, 33, 46, 459357544, time.UTC),
		...
		"/integration": &vfsgen۰DirInfo{
			name:    "integration",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 492988092, time.UTC),
		},
		"/integration/defaults-integration.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-integration.properties",
			modTime:          time.Date(2022, 2, 2, 16, 33, 46, 478079156, time.UTC),
		...
		"/leader": &vfsgen۰DirInfo{
			name:    "leader",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 501524052, time.UTC),
		},
		"/leader/defaults-leader.yml": &vfsgen۰CompressedFileInfo{
			name:             "defaults-leader.yml",
			modTime:          time.Date(2022, 2, 2, 16, 33, 46, 500863372, time.UTC),
		...
		"/populate": &vfsgen۰DirInfo{
			name:    "populate",
			modTime: time.Date(2022, 3, 28, 18, 59, 24, 944277215, time.UTC),
		},
		"/populate/defaults-populate.properties": &vfsgen۰FileInfo{
			name:    "defaults-populate.properties",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 506541549, time.UTC),
		...
		"/sanitize": &vfsgen۰DirInfo{
			name:    "sanitize",
			modTime: time.Date(2022, 2, 8, 17, 31, 36, 180946555, time.UTC),
		},
		"/sanitize/defaults-sanitize.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sanitize.properties",
			modTime:          time.Date(2022, 2, 2, 16, 33, 46, 515379298, time.UTC),
		...
		"/security": &vfsgen۰DirInfo{
			name:    "security",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 522921611, time.UTC),
		},
		"/security/idmdetailsprovider": &vfsgen۰DirInfo{
			name:    "idmdetailsprovider",
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 519299971, time.UTC),
		},
		"/security/idmdetailsprovider/defaults-security-idmdetailsprovider.properties": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2022, 2, 2, 16, 33, 46, 518892824, time.UTC),
		...
		"/sqldb": &vfsgen۰DirInfo{
			name:    "sqldb",
			modTime: time.Date(2022, 2, 8, 17, 31, 36, 185848471, time.UTC),
		},
		"/sqldb/defaults-sqldb.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sqldb.properties",
			modTime:          time.Date(2022, 2, 2, 16, 33, 46, 547618619, time.UTC),
		...
		"/transit": &vfsgen۰DirInfo{
			name:    "transit",
			modTime: time.Date(2022, 2, 8, 17, 31, 36, 190488791, time.UTC),
		},
		"/transit/defaults-transit.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-transit.properties",
			modTime:          time.Date(2022, 2, 2, 16, 33, 46, 580485444, time.UTC),
		...
		"/webservice/defaults-webservice.properties": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2022, 3, 2, 15, 58, 22, 722963738, time.UTC),
