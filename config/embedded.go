...
var EmbeddedDefaultsFileSystem = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2022, 8, 23, 19, 32, 35, 699009958, time.UTC),
		},
		"/app": &vfsgen۰DirInfo{
			name:    "app",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 333120784, time.UTC),
		},
		"/app/defaults-app.properties": &vfsgen۰FileInfo{
			name:    "defaults-app.properties",
			modTime: time.Date(2021, 12, 7, 19, 10, 46, 834626047, time.UTC),
		...
		"/certificate": &vfsgen۰DirInfo{
			name:    "certificate",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 334638954, time.UTC),
		},
		"/certificate/defaults-certificate.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-certificate.properties",
			modTime:          time.Date(2022, 3, 14, 20, 49, 52, 351299411, time.UTC),
		...
		"/consul": &vfsgen۰DirInfo{
			name:    "consul",
			modTime: time.Date(2022, 8, 19, 18, 40, 48, 818379286, time.UTC),
		},
		"/consul/defaults-consul.properties": &vfsgen۰FileInfo{
			name:    "defaults-consul.properties",
			modTime: time.Date(2021, 12, 7, 19, 10, 46, 880480002, time.UTC),
		...
		"/discovery": &vfsgen۰DirInfo{
			name:    "discovery",
			modTime: time.Date(2022, 8, 23, 19, 32, 21, 643501508, time.UTC),
		},
		"/discovery/consulprovider": &vfsgen۰DirInfo{
			name:    "consulprovider",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 335511998, time.UTC),
		},
		"/discovery/consulprovider/defaults-discovery.properties": &vfsgen۰FileInfo{
			name:    "defaults-discovery.properties",
			modTime: time.Date(2020, 7, 17, 15, 25, 27, 45396959, time.UTC),
		...
		"/fs": &vfsgen۰DirInfo{
			name:    "fs",
			modTime: time.Date(2022, 5, 11, 13, 18, 20, 123381860, time.UTC),
		},
		"/fs/defaults-fs.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-fs.properties",
			modTime:          time.Date(2021, 12, 7, 19, 10, 46, 884989241, time.UTC),
		...
		"/integration": &vfsgen۰DirInfo{
			name:    "integration",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 356138760, time.UTC),
		},
		"/integration/defaults-integration.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-integration.properties",
			modTime:          time.Date(2022, 8, 19, 13, 18, 56, 356186885, time.UTC),
		...
		"/leader": &vfsgen۰DirInfo{
			name:    "leader",
			modTime: time.Date(2022, 5, 11, 13, 18, 20, 164521765, time.UTC),
		},
		"/leader/defaults-leader.yml": &vfsgen۰CompressedFileInfo{
			name:             "defaults-leader.yml",
			modTime:          time.Date(2020, 7, 17, 15, 25, 27, 55718818, time.UTC),
		...
		"/populate": &vfsgen۰DirInfo{
			name:    "populate",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 358526058, time.UTC),
		},
		"/populate/defaults-populate.properties": &vfsgen۰FileInfo{
			name:    "defaults-populate.properties",
			modTime: time.Date(2021, 12, 7, 19, 10, 46, 937730817, time.UTC),
		...
		"/sanitize": &vfsgen۰DirInfo{
			name:    "sanitize",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 360336271, time.UTC),
		},
		"/sanitize/defaults-sanitize.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sanitize.properties",
			modTime:          time.Date(2021, 12, 7, 19, 10, 46, 947732417, time.UTC),
		...
		"/security": &vfsgen۰DirInfo{
			name:    "security",
			modTime: time.Date(2022, 8, 23, 16, 59, 6, 333937808, time.UTC),
		},
		"/security/idmdetailsprovider": &vfsgen۰DirInfo{
			name:    "idmdetailsprovider",
			modTime: time.Date(2022, 5, 11, 13, 18, 20, 235223071, time.UTC),
		},
		"/security/idmdetailsprovider/defaults-security-idmdetailsprovider.properties": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 7, 17, 15, 25, 27, 60151587, time.UTC),
		...
		"/sqldb": &vfsgen۰DirInfo{
			name:    "sqldb",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 365786744, time.UTC),
		},
		"/sqldb/defaults-sqldb.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sqldb.properties",
			modTime:          time.Date(2021, 12, 7, 19, 10, 46, 991837491, time.UTC),
		...
		"/transit": &vfsgen۰DirInfo{
			name:    "transit",
			modTime: time.Date(2022, 8, 19, 13, 18, 56, 370034755, time.UTC),
		},
		"/transit/defaults-transit.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-transit.properties",
			modTime:          time.Date(2020, 7, 17, 15, 25, 27, 81143638, time.UTC),
		...
		"/webservice/defaults-webservice.properties": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2022, 3, 14, 20, 49, 52, 397440384, time.UTC),
