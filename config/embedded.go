...
var EmbeddedDefaultsFileSystem = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2021, 2, 19, 15, 20, 55, 963904120, time.UTC),
		},
		"/app": &vfsgen۰DirInfo{
			name:    "app",
		...
		"/fs": &vfsgen۰DirInfo{
			name:    "fs",
			modTime: time.Date(2021, 2, 19, 14, 29, 21, 560034692, time.UTC),
		},
		...
		"/security/idmdetailsprovider": &vfsgen۰DirInfo{
			...
			modTime: time.Date(2021, 2, 11, 20, 52, 54, 89098406, time.UTC),
		},
		...
		"/sqldb": &vfsgen۰DirInfo{
			name:    "sqldb",
			modTime: time.Date(2021, 2, 11, 20, 52, 54, 110430060, time.UTC),
		},
		...
		"/webservice": &vfsgen۰DirInfo{
			name:    "webservice",
			modTime: time.Date(2021, 2, 23, 16, 43, 55, 942505633, time.UTC),
		},
