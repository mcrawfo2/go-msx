...
// CountAllByWithOptions provides a mock function with given fields: ctx, where, dest, options
func (_m *CrudRepositoryApi) CountAllByWithOptions(ctx context.Context, where map[string]interface{}, dest interface{}, options map[cassandra.Option]interface{}) error {
...
// UpdateByWithOptions provides a mock function with given fields: ctx, where, values, options
func (_m *CrudRepositoryApi) UpdateByWithOptions(ctx context.Context, where map[string]interface{}, values map[string]interface{}, options map[cassandra.Option]interface{}) error {
	ret := _m.Called(ctx, where, values, options)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, map[string]interface{}, map[string]interface{}, map[cassandra.Option]interface{}) error); ok {
		r0 = rf(ctx, where, values, options)
	} else {
		r0 = ret.Error(0)
	}
