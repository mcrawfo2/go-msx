...
func ResponseHasNoBody() ResponsePredicate {
	return ResponsePredicate{
		Description: fmt.Sprintf("response.Body == nil"),
		Matches: func(resp *httptest.ResponseRecorder) bool {
			return resp.Body.Len() == 0
		},
		Diff: func(resp *httptest.ResponseRecorder) string {
			return testhelpers.Diff(0, resp.Body.Len())
		},
	}
}
