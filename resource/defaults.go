...
var Defaults = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 6, 15, 19, 48, 56, 105203493, time.UTC),
		},
		"/app": &vfsgen۰DirInfo{
			name:    "app",
			modTime: time.Date(2020, 6, 16, 13, 41, 36, 300414283, time.UTC),
		},
		...
		"/fs": &vfsgen۰DirInfo{
			name:    "fs",
			modTime: time.Date(2020, 5, 18, 13, 44, 28, 894137506, time.UTC),
		},
		...
		"/security": &vfsgen۰DirInfo{
			name:    "security",
			modTime: time.Date(2020, 5, 29, 12, 58, 16, 431453756, time.UTC),
		},
		"/security/idmdetailsprovider": &vfsgen۰DirInfo{
			name:    "idmdetailsprovider",
			modTime: time.Date(2020, 5, 29, 12, 58, 16, 431755015, time.UTC),
		},
		...
		"/sqldb": &vfsgen۰DirInfo{
			name:    "sqldb",
			modTime: time.Date(2020, 6, 16, 13, 41, 25, 219525303, time.UTC),
		},
		"/sqldb/defaults-sqldb.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sqldb.properties",
			modTime:          time.Date(2020, 6, 16, 13, 34, 27, 890714879, time.UTC),
		...
		"/transit": &vfsgen۰DirInfo{
			name:    "transit",
			modTime: time.Date(2020, 5, 18, 13, 44, 28, 908368981, time.UTC),
		},
