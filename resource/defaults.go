...
var Defaults = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 8, 12, 14, 19, 46, 934418445, time.UTC),
		},
		"/app": &vfsgen۰DirInfo{
			name:    "app",
			modTime: time.Date(2020, 8, 7, 15, 6, 58, 215633807, time.UTC),
		},
		...
		"/webservice": &vfsgen۰DirInfo{
			name:    "webservice",
			modTime: time.Date(2020, 8, 12, 13, 38, 37, 778896081, time.UTC),
		},
