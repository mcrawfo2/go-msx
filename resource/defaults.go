...
var Defaults = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 11, 24, 16, 40, 1, 579492826, time.UTC),
		},
		"/app": &vfsgen۰DirInfo{
			name:    "app",
			modTime: time.Date(2020, 11, 23, 19, 14, 26, 823546418, time.UTC),
		},
		...
		"/discovery": &vfsgen۰DirInfo{
			name:    "discovery",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 637446020, time.UTC),
		},
		"/discovery/consulprovider": &vfsgen۰DirInfo{
			name:    "consulprovider",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 636549993, time.UTC),
		},
		...
		"/fs": &vfsgen۰DirInfo{
			name:    "fs",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 638623407, time.UTC),
		},
		"/fs/defaults-fs.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-fs.properties",
			modTime:          time.Date(2020, 11, 19, 19, 10, 30, 638104190, time.UTC),
		...
		"/leader": &vfsgen۰DirInfo{
			name:    "leader",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 656449159, time.UTC),
		},
		...
		"/populate": &vfsgen۰DirInfo{
			name:    "populate",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 658493694, time.UTC),
		},
		...
		"/security": &vfsgen۰DirInfo{
			name:    "security",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 663962890, time.UTC),
		},
		"/security/idmdetailsprovider": &vfsgen۰DirInfo{
			name:    "idmdetailsprovider",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 661660561, time.UTC),
		},
		"/security/idmdetailsprovider/defaults-security-idmdetailsprovider.properties": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 661451377, time.UTC),
		...
		"/sqldb": &vfsgen۰DirInfo{
			name:    "sqldb",
			modTime: time.Date(2020, 11, 23, 19, 14, 26, 830828915, time.UTC),
		},
		"/sqldb/defaults-sqldb.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sqldb.properties",
			modTime:          time.Date(2020, 11, 19, 19, 10, 30, 679539314, time.UTC),
		...
		"/transit": &vfsgen۰DirInfo{
			name:    "transit",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 692192160, time.UTC),
		},
		...
		"/webservice": &vfsgen۰DirInfo{
			name:    "webservice",
			modTime: time.Date(2020, 11, 19, 19, 10, 30, 707011489, time.UTC),
		},
		...
		"/webservice/defaults-webservice.properties": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 11, 19, 19, 10, 30, 702449581, time.UTC),
