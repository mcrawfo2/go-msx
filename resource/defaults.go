...
var Defaults = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2020, 10, 19, 21, 49, 57, 897418958, time.UTC),
		},
		"/app": &vfsgen۰DirInfo{
			name:    "app",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 496344957, time.UTC),
		},
		...
		"/discovery": &vfsgen۰DirInfo{
			name:    "discovery",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 504107861, time.UTC),
		},
		"/discovery/consulprovider": &vfsgen۰DirInfo{
			name:    "consulprovider",
			modTime: time.Date(2020, 10, 15, 23, 17, 27, 337091085, time.UTC),
		},
		...
		"/fs": &vfsgen۰DirInfo{
			name:    "fs",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 504726591, time.UTC),
		},
		"/fs/defaults-fs.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-fs.properties",
			modTime:          time.Date(2020, 8, 25, 23, 35, 23, 873868647, time.UTC),
		...
		"/leader": &vfsgen۰DirInfo{
			name:    "leader",
			modTime: time.Date(2020, 8, 25, 23, 35, 23, 895856039, time.UTC),
		},
		...
		"/populate": &vfsgen۰DirInfo{
			name:    "populate",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 515452429, time.UTC),
		},
		"/populate/defaults-populate.properties": &vfsgen۰FileInfo{
			name:    "defaults-populate.properties",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 515375450, time.UTC),
		...
		"/security": &vfsgen۰DirInfo{
			name:    "security",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 522543195, time.UTC),
		},
		"/security/idmdetailsprovider": &vfsgen۰DirInfo{
			name:    "idmdetailsprovider",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 518620936, time.UTC),
		},
		"/security/idmdetailsprovider/defaults-security-idmdetailsprovider.properties": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2020, 8, 25, 23, 35, 23, 904281374, time.UTC),
		...
		"/sqldb": &vfsgen۰DirInfo{
			name:    "sqldb",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 544444203, time.UTC),
		},
		"/sqldb/defaults-sqldb.properties": &vfsgen۰CompressedFileInfo{
			name:             "defaults-sqldb.properties",
			modTime:          time.Date(2020, 10, 15, 23, 17, 22, 542192844, time.UTC),
		...
		"/transit": &vfsgen۰DirInfo{
			name:    "transit",
			modTime: time.Date(2020, 10, 15, 23, 17, 22, 551464169, time.UTC),
		},
		...
		"/webservice/defaults-webservice.properties": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2020, 8, 25, 23, 35, 23, 949128319, time.UTC),
