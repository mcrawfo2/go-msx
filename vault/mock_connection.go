...
// GetTransitKeys provides a mock function with given fields: ctx, keyName
func (_m *MockConnection) GetTransitKeys(ctx context.Context, keyName string) ([]string, error) {
