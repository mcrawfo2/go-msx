...
// CallVaultAPI provides a mock function with given fields: ctx, method, path, query
func (_m *MockConnection) callVaultAPI(ctx context.Context, method string, path string, query url.Values) (*api.Response, error) {
	ret := _m.Called(ctx, method, path, query)

	var r0 *api.Response
	if rf, ok := ret.Get(0).(func(context.Context, string, string, url.Values) *api.Response); ok {
		r0 = rf(ctx, method, path, query)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, string, url.Values) error); ok {
		r1 = rf(ctx, method, path, query)
	} else {
		r1 = ret.Error(1)
	}
...
// List provides a mock function with given fields: ctx, path, query
func (_m *MockConnection) list(ctx context.Context, path string, query url.Values) (map[string]interface{}, error) {
	ret := _m.Called(ctx, path, query)

	var r0 map[string]interface{}
	if rf, ok := ret.Get(0).(func(context.Context, string, url.Values) map[string]interface{}); ok {
