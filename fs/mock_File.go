...
func (_m *MockFile) Readdir(count int) ([]iofs.FileInfo, error) {
	ret := _m.Called(count)
...
func (_m *MockFile) Stat() (iofs.FileInfo, error) {
	ret := _m.Called()
...
type mockConstructorTestingTNewMockFile interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockFile(t mockConstructorTestingTNewMockFile) *MockFile {
	mock := &MockFile{}
	mock.Mock.Test(t)
